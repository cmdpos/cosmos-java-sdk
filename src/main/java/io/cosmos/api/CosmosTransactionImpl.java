...
public class CosmosTransactionImpl {
    ...
    public static CosmosSignData buildSignData(String chainId, Fee fee, String memo,
                                               List<CosmosAccount> accountFrom) {
        CosmosSignData cosmosSignData = new CosmosSignData(chainId, fee, memo, accountFrom);
        return cosmosSignData;
    }

    public static String buildTransaction(String chainId, String tranType, String msgType,
                                          Fee fee, String memo,
                                          List<CosmosAccount> accountFrom,
    ...
    private static TransferMessageMulti buildTransferMessage(String msgType,
                                                             List<InputOutput> inputs, List<InputOutput> outputs) {
